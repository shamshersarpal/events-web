      ...
      <section className="">
        ...
        <div className="p-4 sm:ml-64 bg-[#fff7f157]  pb-10">
          <div className=" rounded-lg   mt-20">
            <div className="mb-5">
              <h1 className="text-3xl font-semibold">Hi Johan!</h1>
              ...
              <div className="lg:w-2/3 w-full">
                ...
                <div className="grid lg:grid-cols-3 gap-4 md:grid-cols-3 grid-cols-1">
                  <div className="bg-white mx-auto shadow-sm p-5 border rounded-lg w-full h-full border-gray-200">
                    <div className="">
                      <h2 className="text-gray-400 text-sm">Done Trips</h2>
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <div className="bg-green-600/20 px-3 py-1 text-green-600 rounded-md">
                          93.8%
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white mx-auto shadow-sm p-5 border rounded-lg w-full h-full border-gray-200">
                    <div className="">
                      <h2 className="text-gray-400 text-sm">Cancelled Trips</h2>
